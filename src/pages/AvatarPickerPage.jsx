...
const businessCartoonAvatars = [
  ...
  {
    id: 'bmc1',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-male-1&backgroundColor=1A1F2C',
    alt: 'Business man with suit',
    category: 'business-male',
  },
  {
    id: 'bmc2',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-male-2&backgroundColor=333&hair=short03',
    alt: 'Business man with glasses',
    category: 'business-male',
  },
  {
    id: 'bmc3',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-male-3&backgroundColor=403E43&facialHair=beard',
    alt: 'Business man with beard',
    category: 'business-male',
  },
  {
    id: 'bmc4',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-male-4&backgroundColor=0E172A',
    alt: 'Business man professional',
    category: 'business-male',
  },
  {
    id: 'bmc5',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-male-5&backgroundColor=1A1F2C&facialHair=beardMustache',
    alt: 'Business man with mustache',
    category: 'business-male',
  },
  {
    id: 'bmc6',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-male-6&backgroundColor=333&clothingColor=262e33',
    alt: 'Business man in dark suit',
    category: 'business-male',
  },
  ...
  {
    id: 'bfc1',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-female-1&backgroundColor=1A1F2C&clothingColor=262e33',
    alt: 'Business woman with suit',
    category: 'business-female',
  },
  {
    id: 'bfc2',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-female-2&backgroundColor=333&hair=long',
    alt: 'Business woman with long hair',
    category: 'business-female',
  },
  {
    id: 'bfc3',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-female-3&backgroundColor=403E43&accessories=glasses',
    alt: 'Business woman with glasses',
    category: 'business-female',
  },
  {
    id: 'bfc4',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-female-4&backgroundColor=0E172A',
    alt: 'Business woman professional',
    category: 'business-female',
  },
  {
    id: 'bfc5',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-female-5&backgroundColor=1A1F2C&hair=bob',
    alt: 'Business woman with bob cut',
    category: 'business-female',
  },
  {
    id: 'bfc6',
    src: 'https://api.dicebear.com/7.x/personas/svg?seed=business-female-6&backgroundColor=333&hair=pixie',
    alt: 'Business woman with pixie cut',
    category: 'business-female',
  },
  ...
  {
    id: 'not1',
    src: 'https://api.dicebear.com/7.x/notionists/svg?seed=professional-1&backgroundColor=3e4152',
    alt: 'Professional notionist style 1',
    category: 'business-alt',
  },
  {
    id: 'not2',
    src: 'https://api.dicebear.com/7.x/notionists/svg?seed=professional-2&backgroundColor=2c2f3c',
    alt: 'Professional notionist style 2',
    category: 'business-alt',
  },
  {
    id: 'not3',
    src: 'https://api.dicebear.com/7.x/notionists/svg?seed=professional-3&backgroundColor=1a1c22',
    alt: 'Professional notionist style 3',
    category: 'business-alt',
  },
  {
    id: 'lor1',
    src: 'https://api.dicebear.com/7.x/lorelei/svg?seed=professional-1&backgroundColor=3e4152',
    alt: 'Professional lorelei style 1',
    category: 'business-alt',
  },
  {
    id: 'lor2',
    src: 'https://api.dicebear.com/7.x/lorelei/svg?seed=professional-2&backgroundColor=2c2f3c',
    alt: 'Professional lorelei style 2',
    category: 'business-alt',
  },
  {
    id: 'lor3',
    src: 'https://api.dicebear.com/7.x/lorelei/svg?seed=professional-3&backgroundColor=1a1c22',
    alt: 'Professional lorelei style 3',
    category: 'business-alt',
  },
];
...
const professionalMaleAvatars = [
  ...businessCartoonAvatars.filter(
    avatar => avatar.category === 'business-male'
  ),
...
const professionalFemaleAvatars = [
  ...businessCartoonAvatars.filter(
    avatar => avatar.category === 'business-female'
  ),
...
const professionalAltAvatars = [
  ...businessCartoonAvatars.filter(
    avatar => avatar.category === 'business-alt'
  ),
...
function AvatarPickerPage() {
  ...
  const getCurrentAvatarCollection = () => {
    ...
    return activeAvatarCategory === 'male'
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Upload a photo, take a picture, or select an avatar.
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center justify-center p-8 space-y-6">
                ...
                <div className="mt-6">
                  <Button
                    ...
                    disabled={(!customImage && activeTab === 'photo') || saving}
                    variant="default"
                    className="w-32"
                  >
                    {saving ? 'Saving...' : 'Save'}
            ...
            {!capturedPhoto ? (
              ...
              <>
                <img
                  ...
                  className="w-80 h-60 object-cover rounded-lg border mb-4"
                />
                <div className="flex gap-3 mt-4">
