...
const features = [
  {
    ...
    description:
      ' Use advanced insights to guide your content development and marketing strategies — and improve your audience’s experience.',
    mockupBg: 'bg-[#e8e8e8]',
  ...
  {
    id: 2,
    title: 'Increase learner success with data',
    description:
      'By identifying patterns in engagement data and conversion, you can take proactive steps to better meet your audience’s needs.',
    mockupBg: 'bg-[#e8e8e8]',
  ...
  {
    id: 3,
    title: 'Build personalized dashboards',
    description:
