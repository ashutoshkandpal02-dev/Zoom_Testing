...
const features = [
  {
    id: 1,
    title: 'Your membership, your way',
    description:
      ' Curate the ideal learning experience that reflects your unique area of expertise with your choice of courses, communities, digital downloads, and live events in one place.',
    mockupBg: 'bg-[#e8e8e8]',
  ...
  {
    id: 2,
    title: 'Build an invested community',
    description:
      'Foster a sense of belonging and community among audience members who share common interests or goals, leading to stronger engagement and loyalty over time.',
    mockupBg: 'bg-[#e8e8e8]',
  ...
  {
    id: 3,
    title: 'Grow revenue through retention',
    description:
      'Deepen your relationship with your audience by offering ongoing value and support — elements that build trust and advocacy for your brand.',
    mockupBg: 'bg-[#e8e8e8]',
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-normal text-white mb-6 leading-tight">
            ...
            <span className="block">More income for you.</span>
          </h2>
          <p className="text-base sm:text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Whether your goal is to grow your community, earn more revenue, or
            engage and retain your audience, memberships can help.{' '}
          </p>
        </motion.div>
