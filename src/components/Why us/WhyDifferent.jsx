  ...
  const pillars = [
    {
      ...
      longDesc:
        'Our advanced AI creates engaging lessons, assessments, and summaries while maintaining educational quality.',
      icon: (
    ...
    },
    {
      ...
      longDesc:
        'Designed with both educators and learners in mind, our platform offers workflows that simplify complex tasks.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
          <path
            d="M2 12H22"
    ...
    },
    {
      ...
      longDesc:
        'Built on robust cloud infrastructure that scales with your needs with enterprise-grade security and encryption.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
          <path
    ...
    },
    {
      ...
      longDesc:
        'Boost learner motivation with gamification elements, achievement badges, and interactive learning experiences.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
          <path
          ...
          />
          <path
            d="M19.94 11C19.74 8.57 18.78 6.43 17.23 4.86C15.68 3.29 13.64 2.35 11.5 2.14"
            stroke="#16A85C"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M12.06 11C12.26 13.43 13.22 15.57 14.77 17.14C16.32 18.71 18.36 19.65 20.5 19.86"
            stroke="#16A85C"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M4.06 11C4.26 8.57 5.22 6.43 6.77 4.86C8.32 3.29 10.36 2.35 12.5 2.14"
            stroke="#16A85C"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M11.94 11C11.74 13.43 10.78 15.57 9.23 17.14C7.68 18.71 5.64 19.65 3.5 19.86"
            stroke="#16A85C"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Discover why educators worldwide choose Athena for modern learning
            experiences
          </p>
        </motion.div>
        ...
        >
          ...
          >
            Join thousands of educators already using Athena LMS to create
