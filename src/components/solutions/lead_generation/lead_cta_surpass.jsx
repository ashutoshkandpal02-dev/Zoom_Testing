      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Ready to fill your sales funnel?
            </h2>
            ...
            >
              Generate more qualified leads while building your brand—all on a
          ...
          >
            <div className="relative w-full max-w-md lg:max-w-lg">
              <img
                src="https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&h=600&fit=crop&crop=faces"
