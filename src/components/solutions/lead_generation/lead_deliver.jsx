        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                Fuel your sales pipeline with a powerful lead generation
                platform.
              </p>
              <p
                ...
                style={{ fontFamily: 'Arial, sans-serif' }}
              >
                Athena was built to help businesses like you attract, nurture,
          ...
          >
            <div className="relative bg-white shadow-2xl overflow-hidden">
              {/* Dashboard Image */}
              <img
                src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop&crop=edges"
