...
const RevenueHero = () => {
  const products = [
    'The Modern Learning Engine',
    'Leaders Learning Circle',
    'Enterprise L&D Toolkit',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 lg:pr-8">
            ...
            <div className="text-blue-100 text-sm font-medium">
              ...
              <span className="text-white">Revenue generation</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-blue-50 max-w-xl">
              Build a new revenue stream with content you already have.
            </p>
