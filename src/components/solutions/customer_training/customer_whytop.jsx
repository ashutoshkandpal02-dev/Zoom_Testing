  ...
  const features = [
    {
      ...
      description:
        'Launch customer training programs quickly so your customers can start getting value from your product immediately.',
    },
    {
      ...
      description:
        'Create interactive learning paths that keep customers engaged and help them master your product features.',
    },
    {
      ...
      description:
        "Leverage AI to create personalized training content that adapts to each customer's learning style and pace.",
    },
    {
      ...
      description:
        'Integrate training seamlessly into your customer journey, from onboarding to advanced feature adoption.',
    },
  ];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Why leading companies use{' '}
            <span className="text-blue-600">Athena</span> for customer training
          </h2>
          <p
            className="text-lg text-gray-600 max-w-3xl mx-auto font-normal"
            style={{ fontFamily: 'Arial, sans-serif' }}
          >
            Empower your customers with comprehensive training that drives
            product adoption and long-term success
          </p>
        </div>
